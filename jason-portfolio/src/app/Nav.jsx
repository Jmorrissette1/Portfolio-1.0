  ...
  return (
    <div className={styles["nav-bar"]}>
      <ul className={styles["nav-list"]}>
        <li>
          <Image src="Logo-Img.svg" alt="JM logo" width={120} height={100} />
        </li>
        ...
        <li className={styles["nav-item"]}>
          <ul className={styles["social-box"]}>
            <li className={styles["social-icon"]}>
              <a href="https://github.com/Jmorrissette1">
                <Image
                  src="Git-Hub-Black.svg"
                  alt="Github Logo"
                  width={40}
                  height={40}
                />
            ...
            <li className={styles["social-icon"]}>
              <a href="https://www.linkedin.com/in/jasonmorrissette/">
                <Image
            ...
            <li className={styles["social-icon"]}>
              <a href="https://x.com/JasonMorrisset8">
                <Image
                  src="X-black.svg"
                  alt="Github Logo"
                  width={40}
